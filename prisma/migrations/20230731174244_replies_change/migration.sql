...
CREATE TABLE "new_Replies" (
    ...
    CONSTRAINT "Replies_postId_fkey" FOREIGN KEY ("postId") REFERENCES "Post" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
...
INSERT INTO "new_Replies" ("authorId", "content", "createdAt", "id", "parentId", "postId", "professor_approved", "upvotes") SELECT "authorId", "content", "createdAt", "id", "parentId", "postId", "professor_approved", "upvotes" FROM "Replies";
DROP TABLE "Replies";
